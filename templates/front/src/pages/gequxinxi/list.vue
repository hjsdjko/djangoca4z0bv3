...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"0 0 0px","margin":"0px 0 0","borderColor":"#ddd","alignItems":"center","display":"flex","clear":"both","flexWrap":"wrap","background":"#fff","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid","height":"auto","order":"1"}'>
	  ...
	  <el-button v-if="btnAuth('gequxinxi','新增')" :style='{"cursor":"pointer","border":"0px solid #ddd","padding":"0px 10px","margin":"0px 10px 0 0","color":"#fff","borderRadius":"0px","background":"rgba(30,124,9,1)","display":"inline-block","width":"80px","fontSize":"14px","lineHeight":"36px","height":"36px"}' type="primary" @click="add('/index/gequxinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
		  ...
		  <div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
		    ...
		    <div :style='{"width":"100%","padding":"0 0px","overflow":"hidden","alignItems":"center","display":"flex","height":"auto"}' class="item-info">
		      <div :style='{"width":"100%","padding":"0 0px 0 0","textAlign":"center","flex":"1"}'>
				...
				<div class="title">{{item.zhuanji}}</div>
...
<script>
  export default {
    ...
    created() {
		...
		this.$http.get('option/singer/singer').then(res => {
			if (res.data.code == 0) {
				this.singerOptions = res.data.data;
				this.selectOptionsList.push({name:'歌手',list:this.singerOptions,tableName: 'singer',check: -1})
			}
		});
    ...
    methods: {
      ...
      getFenlei() {
		this.$http.get('gequfenlei/list',{}).then(res => {
		  if (res.data.code == 0) {
