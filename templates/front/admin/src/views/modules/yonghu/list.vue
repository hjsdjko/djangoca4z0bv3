		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm">
				...
				<el-row class="actions" :style='{"flexWrap":"wrap","margin":"20px 0","display":"flex"}'>
					...
					<el-button class="btn18" v-if="isAuth('yonghu','性别占比')" type="success" @click="chartDialog1()">
						<span class="icon iconfont icon-xiugai13" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
						性别占比
					</el-button>
					<el-button class="btn18" v-if="isAuth('yonghu','年龄分布')" type="success" @click="chartDialog2()">
						<span class="icon iconfont icon-xiugai13" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
						年龄分布
					</el-button>
				</el-row>
...
//统计接口
    chartDialog1() {
      ...
      this.$nextTick(()=>{
        var xingbieChart1 = echarts.init(document.getElementById("xingbieChart1"),'roma');
        this.$http({
...
//统计接口
    chartDialog2() {
      ...
      this.$nextTick(()=>{
        ...
        var nianlingChart2 = echarts.init(document.getElementById("nianlingChart2"),'roma');
        this.$http({
