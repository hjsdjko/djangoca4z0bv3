<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="歌名" prop="songname">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="歌曲分类" prop="gequfenlei">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="歌曲分类" prop="gequfenlei">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="歌手" prop="singer">
					<el-select :disabled="ro.singer" v-model="ruleForm.singer" placeholder="请选择歌手" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="语言" prop="yuyan">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="版权方" prop="banquanfang">
					<el-input v-model="ruleForm.banquanfang" placeholder="版权方" clearable  :readonly="ro.banquanfang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="版权方" prop="banquanfang">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="歌词大意" prop="gecidayi">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.gecidayi" label="歌词大意" prop="gecidayi">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.gecidayi"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gecidayi = this.ruleForm.gecidayi.replace(reg,'../../../djangoca4z0bv3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
