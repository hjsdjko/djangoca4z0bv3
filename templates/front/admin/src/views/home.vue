...
<div class="content" :style='{"padding":"30px"}'>
	...
	<div :style='{"margin":"0 0 20px 0","alignItems":"center","justifyContent":"center","display":"flex"}'>
		...
		<div :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"0 10px","borderRadius":"4px","display":"flex"}' v-if="isAuth('singer','首页总数')">
			<div :style='{"width":"80px","alignItems":"center","background":"linear-gradient(rgb(93, 129, 166), rgb(67, 102, 140))","justifyContent":"center","display":"flex","height":"80px"}'>
				<span class="icon iconfont icon-zhangjie18" :style='{"color":"#fff","fontSize":"24px"}'></span>
			</div>
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#333","fontWeight":"bold","height":"24px"}'>{{singerCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#666","height":"24px"}'>歌手总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"0 10px","borderRadius":"4px","display":"flex"}' v-if="isAuth('gequxinxi','首页总数')">
			<div :style='{"width":"80px","alignItems":"center","background":"linear-gradient(rgb(93, 129, 166), rgb(67, 102, 140))","justifyContent":"center","display":"flex","height":"80px"}'>
				<span class="icon iconfont icon-tongji7" :style='{"color":"#fff","fontSize":"24px"}'></span>
			</div>
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#333","fontWeight":"bold","height":"24px"}'>{{gequxinxiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#666","height":"24px"}'>歌曲信息总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<!-- echarts -->
	<!-- 5 -->
	<div class="type5" :style='{"alignContent":"flex-start","padding":"10px 20px","borderRadius":"16px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto"}'>
		...
		<div id="singerChart1" class="echarts3" v-if="isAuth('singer','首页统计')"></div>
		<div id="gequxinxiChart1" class="echarts4" v-if="isAuth('gequxinxi','首页统计')"></div>
		<div id="gequxinxiChart2" class="echarts5" v-if="isAuth('gequxinxi','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	methods:{
        ...
        var yonghuChart1 = echarts.init(document.getElementById("yonghuChart1"),'roma');
        this.$http({
    ...
    yonghuChat2() {
      this.$nextTick(()=>{
        ...
        var yonghuChart2 = echarts.init(document.getElementById("yonghuChart2"),'roma');
        this.$http({
        ...
        var singerChart1 = echarts.init(document.getElementById("singerChart1"),'roma');
        this.$http({
        ...
        var gequxinxiChart1 = echarts.init(document.getElementById("gequxinxiChart1"),'roma');
        this.$http({
    ...
    gequxinxiChat2() {
      this.$nextTick(()=>{
        ...
        var gequxinxiChart2 = echarts.init(document.getElementById("gequxinxiChart2"),'roma');
        this.$http({
            url: "gequxinxi/group/xingming",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
